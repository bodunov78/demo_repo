...
def qz():
    ...
    click_button = browser.find_element(By.XPATH,'//*[@id="qid_70217709"]/div/div[2]/test-question-view/div/div/div[2]/test-question-view-rbchk/div/div/div/div[1]/label/i')
    sleep(2)
    click_button.click()
    sleep(5)

    # скопировали шаблон во второй
    click_button = browser.find_element(By.XPATH,'//*[@id="qid_70217709"]/div/div[1]/button[2]/span').click()
    ...
    click_button.send_keys("122!QAZ2wsx")
    ...
    click_button.send_keys("222!QAZ2wsx")
    ...
    click_button.send_keys("322!QAZ2wsx")
    ...
    click_button.send_keys(str(randint(1,200000000)))
    ...
    click_button.send_keys("522!QAZ2wsx")
