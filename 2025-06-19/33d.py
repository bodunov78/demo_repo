...
# urls="https://app.onlinetestpad.com/tests/pgd2srrhikj5q/questions"
urls="https://app.onlinetestpad.com/tests/m5seiht74jtfm/questions,https://app.onlinetestpad.com/tests/t3tmmpaxo33tk/questions,https://app.onlinetestpad.com/tests/n4royktqgs77o/questions,https://app.onlinetestpad.com/tests/yn543lzx62sqw/questions"
# ,https://app.onlinetestpad.com/tests/vsblneaib4c4a/questions,https://app.onlinetestpad.com/tests/5r4ahsb7ez5qm/questions,https://app.onlinetestpad.com/tests/4f2op4l3na2ug/questions,https://app.onlinetestpad.com/tests/dt3yxcztvhrs4/questions,https://app.onlinetestpad.com/tests/zq22nti3pvj2c/questions,https://app.onlinetestpad.com/tests/jggrfj5syynze/questions,https://app.onlinetestpad.com/tests/ytay2f5hn7ovg/questions"
urls="https://app.onlinetestpad.com/tests/m5seiht74jtfm/questions"
urls=list(urls.split(','))
urls=urls[::-1]
print (urls)

f=open("test_2.csv", encoding="utf8")
s = f.readline()
cnt = 0
...
for u,url in enumerate(urls):
    ...
    for i in range(300+u*50,350+u*50):
        m=a[i]
        q1 = f"{m[2]}\n{m[3]}"
        a1 = m[4]
        a2 = m[5]
